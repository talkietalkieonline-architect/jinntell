...
def _build_agent_prompt(
    ...
    if rag_context and rag_context.strip():
        parts.append(f"\n=== РЕЛЕВАНТНЫЕ ФРАГМЕНТЫ ЗАКОНОДАТЕЛЬСТВА ===\n{rag_context.strip()}\n=== КОНЕЦ ФРАГМЕНТОВ ===")
        parts.append("Отвечай СТРОГО на основе приведённых фрагментов. Цитируй номера статей и пунктов. Если информации нет в фрагментах — честно скажи что не нашёл ответ в нормативной базе.")

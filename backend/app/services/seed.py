...
SEED_AGENTS = [
    # ═══ CORE AGENTS (системное ядро, скрыты из Города) ═══
    {
        ...
        "agent_type": "core",
        "visibility": "core",
        "jinntell_link": "assistant",
        "rating": 5.0,
        "greeting": "Привет! Я Джим, ваш персональный помощник в JinnTell. Могу рассказать о сервисе, найти нужного агента или просто поболтать.",
        "system_prompt": """Ты — персональный AI-помощник платформы JinnTell.
